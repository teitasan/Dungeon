...
export var AttributeEffectiveness;
(function (AttributeEffectiveness) {
    AttributeEffectiveness[AttributeEffectiveness["IMMUNE"] = 0] = "IMMUNE";
    AttributeEffectiveness[AttributeEffectiveness["NOT_VERY_EFFECTIVE"] = 0.8] = "NOT_VERY_EFFECTIVE";
    AttributeEffectiveness[AttributeEffectiveness["NORMAL"] = 1] = "NORMAL";
    AttributeEffectiveness[AttributeEffectiveness["SUPER_EFFECTIVE"] = 1.2] = "SUPER_EFFECTIVE";
})(AttributeEffectiveness || (AttributeEffectiveness = {}));
export class AttributeSystem {
     ...
     */
    calculateAttributeModifier(attackerAttribute, defenderAttribute) {
     ...
     */
    calculateEntityAttributeModifier(attacker, defender) {
        ...
        return this.calculateAttributeModifier(attackerAttributes.primary, defenderAttributes.primary);
    }
    /**
     ...
     */
    isEffective(attackerAttribute, defenderAttribute) {
     ...
     */
    isNotVeryEffective(attackerAttribute, defenderAttribute) {
        const modifier = this.calculateAttributeModifier(attackerAttribute, defenderAttribute);
     ...
     */
    hasNoEffect(attackerAttribute, defenderAttribute) {
        const modifier = this.calculateAttributeModifier(attackerAttribute, defenderAttribute);
     ...
     */
    updateCompatibilityMatrix(newMatrix) {
...
//# sourceMappingURL=AttributeSystem.js.map
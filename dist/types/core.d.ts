...
export type ComponentType = 'movement' | 'attack-range' | 'attack-count' | 'attack-target' | 'hunger' | 'dungeon-generator' | 'dungeon-system' | 'death-system' | 'item-identification' | 'item-system' | 'ui-system' | 'level-up' | 'turn-system' | 'attribute';
